...
for i in messages:
    prompt = f" Classify the following customer message into exactly one category:Complaint, Question,Compliment Customer message: {i} Respond with only the category name"
